...
export const THEMES: Theme[] = [
  ...
  },
  {
    ...
    vars: {
      "--menu": "#2a2d33",
      "--bg": "#1c1e22",
      "--bg-grad": "radial-gradient(1100px 650px at 10% -10%, rgba(255,255,255,0.07) 0%, transparent 60%), radial-gradient(900px 600px at 100% 0%, rgba(150,160,190,0.06) 0%, transparent 55%)",
      ...
      "--rail": "#2c1d14",
      "--blur": "20px",
      "--shadow-1": "0 1px 2px rgba(0,0,0,0.3), 0 10px 30px rgba(0,0,0,0.25)",
